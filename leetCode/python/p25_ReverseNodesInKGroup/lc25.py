...
class Solution:
	...
	def reverseKGroup(self, head: ListNode, k: int) -> ListNode:
		...
		print('Size of list: ' + str(list_size))

		num_k_groups = int(list_size / k)

		print('Number of k groups: ' + str(num_k_groups))
		...
		while i < list_size-1:
			if (list_size - i - 1) < k:
				break
			self.reverseBetween(self.head, i+1, i+k)	
			i += k
...
list1.reverseKGroup(list1.head, k)
...
list2.reverseKGroup(list2.head, k)
